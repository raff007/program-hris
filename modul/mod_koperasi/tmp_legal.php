              ...
              <div class="card card-primary card-outline">
                ...
                <h3 class="profile-username text-center" style="text-transform:uppercase"><?= $sp['nama_karyawan'] ?></h3>
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                      <b>ID Kontrak</b> <a class="float-right"><?= $sp['no_skt'] ?></a>
                    </li>
                  </ul>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="kontrak">
                      ...
                      <form method="post"  action="index.php?page=<?= $page ?>&sect=form&act=<?= $actpage ?>" enctype="multipart/form-data">
                      <div class="card">
                      <div class="card-header">
                        <input type="hidden" name="id_kontrak" value="<?= $_GET['id'] ?>">
                        <h3 class="card-title">Form Kontrak</h3>
                      </div>
                      <div class="row">
                      <div class="col">
                        <center><label class="control-label">NK</label>
                        <input type="text" class="form-control" name="nk" placeholder="NK" >
                      </div>
                      <div class="col">
                      ...
                      <div class="col">
                        ...
                        <input type="month" class="form-control" name="bln_thn" placeholder="Bln/Thn">
                      </div>
                      <div class="col">
                        <center><label class="control-label">Awal Kontrak</label>
                        <input type="date" class="form-control" name="masuk_pt" placeholder="Awal Kontrak">
                      </div>
                      <div class="col">
                      ...
                      <div class="col">
                        ...
                        <input type="date" class="form-control" name="keluar_pt" placeholder="Akhir Kontrak">
                      </div>
                    </div>
